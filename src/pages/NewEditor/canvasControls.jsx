...
const CanvasControls = ({ onChange, jsonRef, canvas, handleJsonData }) => {
  ...
  return (
    <div
      className={`flex flex-start gap-2 px-2 py-2 border-b-2 border-amber-50 dark:border-b-fuchsia-500`}
    >
      <MenuButton
        title="Add Image"
